...
public class UserPersonalityDto {
    ...
    public UserPersonalityDto(int eat, int drink, int party, int sleep, int work, int mature, int sport, int movies, int spirituality, int travel, int freak, int animals) {
        this.eat = eat;
        this.drink = drink;
        this.party = party;
        this.sleep = sleep;
